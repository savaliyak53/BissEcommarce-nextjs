...
const Footer2 = () => {
  ...
  return (
    <div className="text-white bg-slate-800">
      <div className="lg:mx-32 sm:mx-16 mx-5 gap-x-5 justify-items-center items-center py-5 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4">
        ...
        <div>
          ...
          <div className="grid justify-items-start items-start">
            ...
            <p className={`${styles.footerHover}`}>Flash Unlimited Shipping</p>
          </div>
        </div>
      </div>
      <div>
        <hr className="relative top-4" />
        <div className="bg-gray-800 text-2xl text-center">
          <a
            href="#forTop"
            className="p-3 z-20 relative mx-auto rounded-md bg-blue-500"
          >
            Back to Top
          </a>
        </div>
